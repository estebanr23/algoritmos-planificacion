...
var procesos = [
    {nombre: 'P1', ejecucion: 5, llegada: 2, prioridad: 3},
    {nombre: 'P2', ejecucion: 7, llegada: 1, prioridad: 4},
    {nombre: 'P3', ejecucion: 9, llegada: 5, prioridad: 1},
    {nombre: 'P4', ejecucion: 3, llegada: 8, prioridad: 1},
    {nombre: 'P5', ejecucion: 4, llegada: 7, prioridad: 2}
]
*/
var procesos = [
    {nombre: 'P1', ejecucion: 3, llegada: 0, prioridad: 2},
    {nombre: 'P2', ejecucion: 5, llegada: 0, prioridad: 1},
    {nombre: 'P3', ejecucion: 3, llegada: 5, prioridad: 10},
    {nombre: 'P4', ejecucion: 2, llegada: 5, prioridad: 3},
    {nombre: 'P5', ejecucion: 4, llegada: 6, prioridad: 1}
]
